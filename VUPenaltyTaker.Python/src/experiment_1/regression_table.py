...
def model_1_table(inference_data: Path, file_name: Path, persistence: Persistence):
    ...
    table.rename_element("goalkeeper_displacement", "Goalkeeper[Right]")
    table.rename_element("advertisement_direction[Right]", "Background Motion[Right]")
    table.rename_element("goalkeeper_displacement:advertisement_direction[Right]", "Goalkeeper × Background Motion")
