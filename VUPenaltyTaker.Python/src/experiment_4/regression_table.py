...
def model_1_table(inference_data: Path, file_name: Path, persistence: Persistence):
    ...
    table.rename_element("advertisement_direction:condition[Left, AdvertisementAndGoal]", "Background Motion [Left] × Goal")
    table.rename_element("advertisement_direction:condition[Right, AdvertisementAndGoal]", "Background Motion [Right] × Goal")
