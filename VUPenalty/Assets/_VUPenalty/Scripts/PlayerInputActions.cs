...
public partial class @PlayerInputActions : IInputActionCollection2, IDisposable
{
    ...
    public struct FootActions
    {
        ...
        public void SetCallbacks(IFootActions instance)
        {
            ...
            {
                @Position.started -= m_Wrapper.m_FootActionsCallbackInterface.OnPosition;
                @Position.performed -= m_Wrapper.m_FootActionsCallbackInterface.OnPosition;
                @Position.canceled -= m_Wrapper.m_FootActionsCallbackInterface.OnPosition;
                @Rotation.started -= m_Wrapper.m_FootActionsCallbackInterface.OnRotation;
                @Rotation.performed -= m_Wrapper.m_FootActionsCallbackInterface.OnRotation;
                @Rotation.canceled -= m_Wrapper.m_FootActionsCallbackInterface.OnRotation;
            }
